/**************************************************************************/
/*  barista_script_resource_loader.h                                      */
/*                                                                        */
...
class BaristaScriptResourceLoader final : public godot::ResourceFormatLoader {
	GDCLASS(BaristaScriptResourceLoader, godot::ResourceFormatLoader)
