...
- passing/                    paired case + a .notest.fs helper (skipped, not counted)
- ignored_directory/          .fsignore opts the directory out; its case is skipped
- missing_expectation/        .fs with no .out
- orphaned_expectation/       .out with no .fs
