...
namespace {
void scenario_pinned_suite_exit_summary() {
...
void scenario_pinned_match_finality_domains() {
	StorageFixture fixture;
	AnalyzerSettings settings;
...
void scenario_pinned_match_domain_and_narrowing_audit() {
	StorageFixture fixture;
	AnalyzerSettings settings;
	settings.warnings_enabled(true);
	settings.warning(BSWarning::NON_EXHAUSTIVE_MATCH, BSWarning::WARN);
...
void scenario_pinned_for_assert_consumers() {
	StorageFixture fixture;
	AnalyzerSettings settings;
	settings.warnings_enabled(true);
...
void scenario_pinned_suite_datatypes() {
	StorageFixture fixture;
	AnalyzerSettings settings;
	settings.warnings_enabled(false);
	struct DatatypeCase {
...
void scenario_native_iterator_annotation_nullability() {
	StorageFixture fixture;
	AnalyzerSettings settings;
	settings.warnings_enabled(false);
...
void scenario_internal_type_test_exhaustion() {
	StorageFixture fixture;
...
TEST_SUITE("analyzer_flow") {
	TEST_CASE("pinned_suite_exit_summary") { scenario_pinned_suite_exit_summary(); }
	TEST_CASE("pinned_match_finality_domains") { scenario_pinned_match_finality_domains(); }
	TEST_CASE("pinned_match_domain_and_narrowing_audit") { scenario_pinned_match_domain_and_narrowing_audit(); }
	TEST_CASE("pinned_for_assert_consumers") { scenario_pinned_for_assert_consumers(); }
	TEST_CASE("pinned_suite_datatypes") { scenario_pinned_suite_datatypes(); }
	TEST_CASE("native_iterator_annotation_nullability") { scenario_native_iterator_annotation_nullability(); }
	TEST_CASE("internal_type_test_exhaustion") { scenario_internal_type_test_exhaustion(); }
	TEST_CASE("normal_reversed_shuffled_cases_restore_ambient_state") {
		check_scenario_orders({ scenario_pinned_suite_exit_summary, scenario_pinned_match_finality_domains, scenario_pinned_match_domain_and_narrowing_audit, scenario_pinned_for_assert_consumers, scenario_pinned_suite_datatypes, scenario_native_iterator_annotation_nullability, scenario_internal_type_test_exhaustion });
	}
}
