...
TEST_SUITE("analyzer_flow") {
	TEST_CASE("pinned_suite_exit_summary") {
		...
		const SourceCase cases[] = {
			...
			{ "body_unknown_call", "func f() -> int:\n\tunknown_abort()\n", { E("Identifier \"unknown_abort\" not declared in the current scope.", 2, 5) }, {}, Phase::BODY_EXPRESSION_CALLABLE_SIGNAL },
			{ "body_failure_before_flow", "func f() -> int:\n\tmissing_name\n", { E("Identifier \"missing_name\" not declared in the current scope.", 2, 5) }, {}, Phase::BODY_EXPRESSION_CALLABLE_SIGNAL },
	...
	TEST_CASE("pinned_match_domain_and_narrowing_audit") {
		...
		const SourceCase cases[] = {
			...
			{ "narrow_2948_assignment_source", "func test(maybe: Node?) -> void:\n\tvar node: Node = maybe\n", { E("Cannot assign a value of type \"Node?\" to a variable of type \"Node\".", 2, 22) }, {}, Phase::BODY_EXPRESSION_CALLABLE_SIGNAL, true, false },
